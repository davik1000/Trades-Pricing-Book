...
<body>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <!-- Active table search and filter -->
        <script>
            function activeFunction() {
                // Declare variables
                var input, filter, table, tr, td, i, txtValue;
                input = document.getElementById("active_input");
                filter = input.value.toUpperCase();
                table = document.getElementById("active_table");
        ...
        <!-- Archived table search and filter -->
        <script>
            function archivedFunction() {
                // Declare variables
                var input, filter, table, tr, td, i, txtValue;
                input = document.getElementById("archived_input");
                filter = input.value.toUpperCase();
                table = document.getElementById("archived_table");
                tr = table.getElementsByTagName("tr");
        ...
        <script>
            function activeFunction2() {
                // Declare variables
                var input, filter, table, tr, td, i, txtValue;
                input = document.getElementById("active_input2");
                filter = input.value.toUpperCase();
                table = document.getElementById("active_table2");
                tr = table.getElementsByTagName("tr");
        ...
        <!-- Archived table search and filter -->
        <script>
            function archivedFunction2() {
                // Declare variables
                var input, filter, table, tr, td, i, txtValue;
                input = document.getElementById("archived_input2");
                filter = input.value.toUpperCase();
                table = document.getElementById("archived_table2");
                tr = table.getElementsByTagName("tr");
